    ...
    require(["zepto", "ajax_rule", "native"],function($, ajax_rule, native){
        $(function() {
            $(document).ready(function() {
                ...
                $(".js_consumer_add").on("click", function () {
                    var openUrl = location.protocol + '//' + location.host + '/store/v1/page/consumer_registe.html';
                ...
                $(".js_consumer_all").on("click", function () {
                    var openUrl = location.protocol + '//' + location.host + '/store/v1/page/consumer_list.html';
                    if (window.WebViewJavascriptBridge !== "undefined") {
                        var openUrlData ={
                            url:openUrl,
                            pullDown:"0",
                ...
                $(".js_consumer_check").on("click", function () {
                    var openUrl = location.protocol + '//' + location.host + '/store/v1/page/consumer_check.html';
                    if (window.WebViewJavascriptBridge !== "undefined") {
                        var openUrlData ={
                            url:openUrl,
                            pullDown:"0",
                ...
                $(".js_consumer_search").on("click", function () {
                    var openUrl = location.protocol + '//' + location.host + '/store/v1/page/consumer_find.html';
                    if (window.WebViewJavascriptBridge !== "undefined") {
                        var openUrlData ={
                            url:openUrl,
                            pullDown:"0",
